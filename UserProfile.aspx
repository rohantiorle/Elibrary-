<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="onlline_liberay.UserProfile" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="Bootstrap/img/generaluser.png"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="Bootstrap/img/books1.png"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
